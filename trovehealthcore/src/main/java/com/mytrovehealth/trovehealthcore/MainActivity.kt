...
import com.mytrovehealth.trovehealthcore.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    companion object {
         ...
         */
        private const val TEMPLATE_ID: String = "itmpl_4ckW6nF3ZiLPaAnS79zauEKN"
    }
    ...
    private val getInquiry = registerForActivityResult(Inquiry.Contract()) { inquiry ->
        when (inquiry) {
            ...
            is InquiryResponse.Error -> {
                Log.e("MainActivity","Inquiry Error ${inquiry.debugMessage}")
                resultPresenter.showResults(
                    title = "Inquiry Error",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            startInquiryView.btnHuman.setOnClickListener {
                if (TEMPLATE_ID.contains("itmpl_PUT_YOUR_TEMPLATE_ID_HERE")) {
